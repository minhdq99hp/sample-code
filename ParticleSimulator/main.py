...
def test_visualize():
    particles = [Particle(0.3, 0.5, 1), Particle(0.0, -0.5, -1.0), Particle(-0.1, -0.4, 3.0)]
...
def test():
    '''
    Make sure that the program run correctly
    '''
    return 
...
if __name__ == '__main__':
    benchmark() 
    # run `time python main.py` will return something like:
    # real    0m7.998s
    # user    0m8.094s
    # sys     0m0.221s